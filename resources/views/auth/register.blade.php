...
@section('content')
    ...
    <div class="col-md-8 blog-main">
        <h3 class="pb-3 mb-4 font-italic border-bottom">@lang('authforms.register')</h3>
            ...
            <div class="card-body d-flex flex-column">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">@lang('authforms.login')</label>
